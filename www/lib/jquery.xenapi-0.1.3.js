...
(function() {
  "use strict";  window.XenAPI = function(username, password, hosturl) {
    var external, internal, _call, _connect, _convertJSON, _getCurrentSession, _getError, _getResult, _getServerVersion, _getSession, _storeFunctions, _init, _responseHandler, _serializeSession, _serializeUrl, _xmlrpc,
      _this = this;
    ...
    _storeFunctions =function(){
        var txt=_call("system.listMethods", false);
        return txt;
    };
    ...
    _init = function(callback) {
      ...
      /*This is start of the editing of XenAPI
      var txt=_call("system.listMethods", false);
      setTimeout(function () {console.log(txt.responseText);}, 3000);
    ...
    external = {};
    external.storeFunctions = function() {
      return _storeFunctions();
    };
